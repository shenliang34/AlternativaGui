...
{
	import com.gamehero.sxd2.gui.main.menuBar.IBagButton;
	 ...
	 * @author weiyanyu
	 */	
	public class ActTabBtn extends TabSbutton implements IBagButton
	{
		/**
		 * 数值相关的容器
		 */
		...
		public function ActTabBtn(stateUpSkin:BitmapData, stateDownSkin:BitmapData = null, stateOverSkin:BitmapData = null,dis:BitmapData = null,redType:String = ActTabBtnRedPointType.RED_CHAT_POINT)
		{
			super(stateUpSkin, stateDownSkin, stateOverSkin,dis);
